        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Tire suas dúvidas diretamente pelo WhatsApp e descubra como a mentoria pode transformar seu negócio.
            </p>
            <a
              href={whatsappLink}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-semibold transition-colors"
            >
              <WhatsAppIcon />
              Falar no WhatsApp
            </a>
